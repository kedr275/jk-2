...
from com.vmware.vcloud.suite.sample.vim.helpers.get_cluster_by_name import get_cluster_id
...
logger = LoggingContext.get_logger('com.vmware.vcloud.suite.sample.workflow.tagging_workflow')
...
def main():
    tagging_workflow = TaggingWorkflow(platformservicecontroller=None)
