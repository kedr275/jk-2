...
logger = LoggingContext.get_logger('com.vmware.vcloud.suite.sample.common.lookup_service_helper')


class LookupServiceHelper(object):
    def __init__(self, wsdl_url, soap_url):
...
def main():
    lookup_service_helper = LookupServiceHelper(wsdl_url='file:///path/to/lookupservice.wsdl',
                                                soap_url='https://203.0.113.0/lookupservice/sdk')
