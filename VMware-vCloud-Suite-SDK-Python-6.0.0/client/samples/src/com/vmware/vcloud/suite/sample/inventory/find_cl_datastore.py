...
from com.vmware.vcloud.suite.sample.vim.helpers.vim_utils import get_obj_by_moId
...
logger = LoggingContext.get_logger('com.vmware.vcloud.suite.sample.inventory.find_cl_datastore')
...
class FindClDatastore(SampleBase):
    ...
    (Please refer to com.vmware.vcloud.suite.sample.workflow.content_library_workflow for details on how to create a content library)
    """
...
def main():
    find_cl_datastore = FindClDatastore(platformservicecontroller=None)
